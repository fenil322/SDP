      ...
      <div>
        ...
        <div class="bg-white rounded-lg shadow-xl pb-8">
          ...
          <div class="flex flex-col items-center -mt-20">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT7XJfS6pt30XMVTuDoHk4IviKg7N4-Lmlh64SJ7KJrnES0pNRv1vb_JMu8noHPJ49wjV0&usqp=CAU"
          ...
          <div className="flex">
            <div className="inset-y-0">
              <button
                type="button"
                class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-semibold rounded-full text-sm px-2.5 py-1.5 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700"
              >
                Share
              </button>
            </div>

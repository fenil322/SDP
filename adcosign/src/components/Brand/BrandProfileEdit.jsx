              ...
              <div>
                    ...
                    <div class="md:grid grid-cols-12 flex flex-col md:items-center gap-4 p-4">
                      ...
                      <div class="col-span-6 relative">
                        ...
                        <input
                          type="text"
                          name="cat1"
                          defaultValue={brandData.cat1}
                          // value={brandData.cat1}
                          onChange={handleInput}
                          class="text-[13px] h-12 text-gray-700 w-full border-2 px-2 rounded-sm"
                        />
                      </div>
                      <div class="col-span-6 relative">
                        ...
                        <input
                          type="text"
                          name="cat2"
                          defaultValue={brandData.cat2}
                          // value={brandData.cat2}
                          onChange={handleInput}
                          class="text-[13px] h-12 text-gray-700 w-full border-2 px-2 rounded-sm"
                        />
                      </div>
                      <div class="col-span-6 relative">
                        ...
                        <input
                          type="text"
                          name="cat3"
                          defaultValue={brandData.cat3}
                          // value={brandData.cat3}
                          onChange={handleInput}
                          class="text-[13px] h-12 text-gray-700 w-full border-2 px-2 rounded-sm"
                        />
                      </div>
                ...
                <div class="col-span-6 relative mt-16">
                  ...
                  <textarea
                    type="textbox"
                    name="discription"
                    defaultValue={brandData.discription}
                    // value={brandData.fname}
                    onChange={handleInput}

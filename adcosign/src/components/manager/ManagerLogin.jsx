            ...
            <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
              <div class="flex-1">
                ...
                <div class="mt-8">
                  ...
                  <p class="mt-6 text-sm text-center text-gray-400">Don&#x27;t have an account yet? <a href="/ManagerSignUp" class="text-blue-500 focus:outline-none focus:underline hover:underline">Sign up</a>.</p>
                </div>
              </div>
            </div>
          </div>

...
const InfluencerLogin = () => {
  ...
  const activebtn =
    "flex justify-center w-full px-6 py-3 mt-4 text-blue-500 border border-white rounded-md md:mt-0 md:w-auto md:mx-2 focus:outline-none";
  const deactivebtn =
    "hover:bg-blue-400 flex justify-center w-full px-6 py-3 text-white bg-blue-500 rounded-md md:w-auto md:mx-2 focus:outline-none";
                ...
                <div class="flex items-center p-5 rounded-lg  mx-auto bg-opacity-25 bg-white">
                  <div class="flex-1">
                    <div class="text-center item-center ">
                      <p class="pb-5 text-white font-bold text-xl dark:text-gray-300">
                        Sign in to access your account as
                      </p>
                            ...
                            <>
                              <form method="POST">
                                <div>
                                  <label
                                    for="email"
                                    class="block mb-2 text-lg text-white dark:text-gray-200"
                                  >
                                    Email Address
                                  </label>
                                  <input
                                ...
                                <div class="mt-6">
                                  <div class="flex justify-between">
                                    <label
                                      for="password"
                                      class="text-lg text-white dark:text-gray-200"
                                    >
                                      Password
                                    </label>
                                    <a
                                      href="#"
                                      class="text-sm text-white focus:text-blue-500 hover:text-blue-500 hover:underline"
                                    >
                                      Forgot password?
                                    </a>
                                  </div>
                    ...
                    <div className="input-group-btn">
                     ...
                     { passwordType==="password"? <i className="bi bi-eye-slash"></i> :<i className="bi bi-eye"></i> }
                      ...
                      <p class="mt-6 text-lg text-center text-white">
                        Don&#x27;t have an account yet?{" "}
                        <a
                          href="/InfluencerSignUp"
                          class="text-blue-300 focus:outline-none focus:underline hover:underline"
                        >
                          Sign up
                        </a>
                        .

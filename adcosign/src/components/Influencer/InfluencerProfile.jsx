...
const InfluencerProfile = () => {
  ...
  return (
    <body className="bg-slate-300 p-6">
  ...
  <div class="shrink-0">
    <img class="h-16 w-16 object-cover rounded-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7QY2ioIRa17CorwDpwkHIujVaLvc6R_FpMA&usqp=CAU" alt="Current pictures" />
  </div>
  <label class="block">
